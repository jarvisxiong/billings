...
<body>
	...
	<img src="${templatePath}/img/ok.jpg" alt="记账，就像和朋友对话" title="记账，就像和朋友对话" width="450"/>
	<div style="display:block;width:500px;float:right;margin-top:30px;">
	<span id="" style="margin:auto;display:block;text-align:center;"><span style="color:#f39;font-weight:700;font-size:30px;">恭喜您！！！</span><br />页面将在<span id="view"></span>秒后跳转……</span>
	<p>&nbsp;</p>
	<span id="" style="display:block;text-align:center;">您正在尝试<span style="color:#f36;font-weight:600;font-size:16px;">${okpos}</span>；看到此页面说明您<span style="color:#f36;font-weight:600;font-size:16px;">${okmsg}</span></span>
	<p>&nbsp;</p>
